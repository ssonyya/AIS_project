...
class TestWeatherRepositoryService(unittest.TestCase):
    ...
    def test_create_car(self):
        ...
        car = GenerationData()
        result = create_car(self.session, name="r777os", coord_x=car.getX(), coord_y=car.getY(),
    ...
    def test_delete_car(self):
        ...
        delete_car_by_name(self.session, name="r777os")
        result = get_car_by_name(self.session, name="r777os")
